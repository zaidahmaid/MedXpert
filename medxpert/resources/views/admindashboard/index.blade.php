...
@section('contant')
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-solid fa-user-doctor fa-2x text-gray-800"></i>
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-solid fa-users fa-2x text-gray-800"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Doctor Distribution by City</h6>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> Amman Doctors
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Zarqa Doctors
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Irbid Doctors
                                        </span>
                                    </div>
                                </div>
                            </div>
            ...
            <script>
                window.doctorStats = {
                    amman: @json($doctorAmman),
                    zarqa: @json($doctorZarqa),
                    irbid: @json($doctorIrbid)
                };
            </script>
