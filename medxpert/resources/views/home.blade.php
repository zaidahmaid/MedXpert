    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                <!-- All specialty cards with unified blue theme -->
                <!-- Specialty Card 1 -->
                <div class="category-card bg-white p-6 rounded-xl shadow-md text-center">
                    ...
                    <p class="text-sm text-gray-500">48 Doctors</p>
                </div>
                ...
                <div class="category-card bg-white p-6 rounded-xl shadow-md text-center">
                    ...
                    <p class="text-sm text-gray-500">36 Doctors</p>
                </div>
                ...
                <div class="category-card bg-white p-6 rounded-xl shadow-md text-center">
                    ...
                    <p class="text-sm text-gray-500">29 Doctors</p>
                </div>
                ...
                <div class="category-card bg-white p-6 rounded-xl shadow-md text-center">
                    ...
                    <p class="text-sm text-gray-500">42 Doctors</p>
                </div>
                ...
                <div class="category-card bg-white p-6 rounded-xl shadow-md text-center">
                    ...
                    <p class="text-sm text-gray-500">31 Doctors</p>
                </div>
                ...
                <div class="category-card bg-white p-6 rounded-xl shadow-md text-center">
                    ...
                    <p class="text-sm text-gray-500">25 Doctors</p>
                </div>
            </div>
