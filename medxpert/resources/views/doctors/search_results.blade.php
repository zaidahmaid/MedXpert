        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach($doctors as $doctor)
                <div class="doctor-card p-6 bg-white rounded-lg shadow-md">
                    ...
                    <p class="text-gray-600">{{ $doctor->doctorDetail->specialty }}</p>
                    <p class="text-gray-500">{{ $doctor->doctorDetail->city }}</p>
                    <p class="text-blue-600">Price: ${{ $doctor->doctorDetail->price }}</p>
